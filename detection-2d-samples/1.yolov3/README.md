...
```bash
$ git clone https://github.com/ultralytics/yolov3 && cd 1.yolov3

# convert darknet cfg/weights to pytorch model
$ python3  -c "from models import *; convert('cfg/yolov3-spp.cfg', 'weights/yolov3-spp.weights')"
Success: converted 'weights/1.yolov3-spp.weights' to 'weights/1.yolov3-spp.pt'

# convert cfg/pytorch model to darknet weights
$ python3  -c "from models import *; convert('cfg/yolov3-spp.cfg', 'weights/yolov3-spp.pt')"
Success: converted 'weights/1.yolov3-spp.pt' to 'weights/1.yolov3-spp.weights'
```
...
```bash
$ python3 test.py --cfg 1.yolov3-spp.cfg --weights 1.yolov3-spp-ultralytics.pt --img 640 --augment

Namespace(augment=True, batch_size=16, cfg='cfg/1.yolov3-spp.cfg', conf_thres=0.001, data='coco2014.data', device='', img_size=640, iou_thres=0.6, save_json=True, single_cls=False, task='test', weights='weight
...
```bash
$ python train.py --data coco2014.data --weights '' --batch-size 16 --cfg 1.yolov3-spp.cfg
$ python train.py --data coco2014.data --weights '' --batch-size 32 --cfg 1.yolov3-tiny.cfg
```
