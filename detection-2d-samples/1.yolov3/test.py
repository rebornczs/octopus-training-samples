...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/1.yolov3-spp.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/coco2014.data', help='*.data path')
    parser.add_argument('--weights', type=str, default='weights/1.yolov3-spp-ultralytics.pt', help='weights path')
