...
# 1.yolov3-tiny weights from darknet (first 16 layers only)
# ./darknet partial cfg/1.yolov3-tiny.cfg 1.yolov3-tiny.weights 1.yolov3-tiny.conv.15 15
# mv 1.yolov3-tiny.conv.15 ../
