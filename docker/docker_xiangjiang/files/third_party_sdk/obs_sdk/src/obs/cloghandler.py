...
# sibling modules than handles all the ugly platform-specific details of file locking
...
# Publish this class to the "logging.handlers" modules so that it can be use
